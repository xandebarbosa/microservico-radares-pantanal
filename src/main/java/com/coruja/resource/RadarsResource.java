...
@Tag(name = "Radares Concessionária Pantanal", description = "Leituras de radares da Concessionária Pantanal")
@Slf4j
public class RadarsResource {
    ...
    public Response buscarComFiltros(
        ...
        RadarPageDTO resultado = radarsService.buscarComFiltros(
                placa, praca, sentido, data, horaInicial, horaFinal, rodovia, page, size
        );
    ...
    /**
     * Endpoint UNIFICADO para busca por placa.
     * Exemplos:
     *   GET /radares/placa
     */
    @GET
    ...
    public Response listarPracas() {
        List<PracaDTO> pracas = radarsService.listarLocaisComoRodovias();
    ...
    public Response getAllLocations() {
        log.info("🚨 [Pantanal-MAPA] SUCESSO! A requisição do BFF conseguiu chegar na Rondon!");

        List<RadarLocationDTO> locations = radarsService.getAllLocations();
        log.info("🚨 [Pantanl-MAPA] Devolvendo {} coordenadas para o BFF desenhar.", locations.size());
